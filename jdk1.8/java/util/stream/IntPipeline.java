 ...
 * @since 1.8
 */
abstract class IntPipeline<E_IN> extends AbstractPipeline<, , > implements IntStream {
  /**
   ...
   */
  IntPipeline(java.util.function.Supplier<? extends Spliterator<Integer>> source, int sourceFlags, boolean parallel) {
   ...
   * @param parallel {@code true} if the pipeline is parallel
   */
  IntPipeline(java.util.Spliterator<Integer> source, int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
  }
   ...
   * by casting.
   */
  private static java.util.function.IntConsumer adapt(Sink<Integer> sink)
  {
   ...
   */
  private static java.util.Spliterator.OfInt adapt(java.util.Spliterator<Integer> s)
  {
  ...
  @Override
  final <P_IN> Node<Integer> evaluateToNode(PipelineHelper<Integer> helper, java.util.Spliterator<P_IN> spliterator, boolean flattenTree, java.util.function.IntFunction<Integer[]> generator) {
        return Nodes.collectInt(helper, spliterator, flattenTree);
  }

  @Override
  final <P_IN> java.util.Spliterator<Integer> wrap(PipelineHelper<Integer> ph, java.util.function.Supplier<Spliterator<P_IN>> supplier, boolean isParallel) {
        return new StreamSpliterators.IntWrappingSpliterator<>(ph, supplier, isParallel);
  }

  @Override
  @SuppressWarnings("unchecked")
  final java.util.Spliterator.OfInt lazySpliterator(java.util.function.Supplier<? extends Spliterator<Integer>> supplier) {
        return new StreamSpliterators.DelegatingSpliterator.OfInt((Supplier<Spliterator.OfInt>) supplier);
  }

  @Override
  final void forEachWithCancel(java.util.Spliterator<Integer> spliterator, Sink<Integer> sink) {
  ...
  @Override
  final Node.Builder<Integer> makeNodeBuilder(long exactSizeIfKnown, java.util.function.IntFunction<Integer[]> generator) {
  ...
  @Override
  public final IntStream map(java.util.function.IntUnaryOperator mapper) {
  ...
  @Override
  public final <U> Stream<U> mapToObj(java.util.function.IntFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final LongStream mapToLong(java.util.function.IntToLongFunction mapper) {
        Objects.requireNonNull(mapper);
        return new LongPipeline.StatelessOp<Integer>(this, StreamShape.INT_VALUE,
                                                     StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            @Override
  ...
  @Override
  public final DoubleStream mapToDouble(java.util.function.IntToDoubleFunction mapper) {
        Objects.requireNonNull(mapper);
        return new DoublePipeline.StatelessOp<Integer>(this, StreamShape.INT_VALUE,
                                                       StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            @Override
  ...
  @Override
  public final IntStream flatMap(java.util.function.IntFunction<? extends IntStream> mapper) {
        return new StatelessOp<Integer>(this, StreamShape.INT_VALUE,
  ...
  @Override
  public final IntStream filter(java.util.function.IntPredicate predicate) {
  ...
  @Override
  public final IntStream peek(java.util.function.IntConsumer action) {
  ...
  @Override
  public final int reduce(int identity, java.util.function.IntBinaryOperator op) {
        return evaluate(ReduceOps.makeInt(identity, op));
  }

  @Override
  public final java.util.OptionalInt reduce(java.util.function.IntBinaryOperator op) {
        return evaluate(ReduceOps.makeInt(op));
  }

  @Override
  public final <R> R collect(java.util.function.Supplier<R> supplier, java.util.function.ObjIntConsumer<R> accumulator, java.util.function.BiConsumer<R, R> combiner) {
  ...
  @Override
  public final boolean anyMatch(java.util.function.IntPredicate predicate) {
        return evaluate(MatchOps.makeInt(predicate, MatchOps.MatchKind.ANY));
  }

  @Override
  public final boolean allMatch(java.util.function.IntPredicate predicate) {
        return evaluate(MatchOps.makeInt(predicate, MatchOps.MatchKind.ALL));
  }

  @Override
  public final boolean noneMatch(java.util.function.IntPredicate predicate) {
  ...
  static class Head<E_IN> extends IntPipeline<> {
    /**
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    Head(java.util.function.Supplier<? extends Spliterator<Integer>> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    Head(java.util.Spliterator<Integer> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
  ...
  static abstract class StatelessOp<E_IN> extends IntPipeline<> {
    /**
  ...
  static abstract class StatefulOp<E_IN> extends IntPipeline<> {
    /**
    ...
    @Override
    abstract <P_IN> Node<Integer> opEvaluateParallel(PipelineHelper<Integer> helper, java.util.Spliterator<P_IN> spliterator, java.util.function.IntFunction<Integer[]> generator) ;
