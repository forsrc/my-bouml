 ...
 * @since 1.8
 */
abstract class AbstractPipeline<E_IN, E_OUT, S extends BaseStream<E_OUT, S>> extends PipelineHelper<> implements BaseStream<, > {
   ...
   * 
   */
  private java.util.function.Supplier<? extends Spliterator<?>> sourceSupplier;
   ...
   */
  AbstractPipeline(java.util.function.Supplier<? extends Spliterator<?>> source, int sourceFlags, boolean parallel) {
   ...
   */
  AbstractPipeline(java.util.Spliterator<?> source, int sourceFlags, boolean parallel) {
        this.previousStage = null;
  ...
  final Node<E_OUT> evaluateToArrayNode(java.util.function.IntFunction<E_OUT[]> generator) {
        if (linkedOrConsumed)
            throw new IllegalStateException(MSG_STREAM_LINKED);
        linkedOrConsumed = true;
   ...
   */
  @SuppressWarnings("unchecked")
  private java.util.Spliterator<?> sourceSpliterator(int terminalFlags) {
  ...
  @Override
  final <P_IN> long exactOutputSizeIfKnown(java.util.Spliterator<P_IN> spliterator) {
        return StreamOpFlag.SIZED.isKnown(getStreamAndOpFlags()) ? spliterator.getExactSizeIfKnown() : -1;
  }

  @Override
  final <P_IN, S extends Sink<E_OUT>> S wrapAndCopyInto(S sink, java.util.Spliterator<P_IN> spliterator) {
        copyInto(wrapSink(Objects.requireNonNull(sink)), spliterator);
        return sink;
  }

  @Override
  final <P_IN> void copyInto(Sink<P_IN> wrappedSink, java.util.Spliterator<P_IN> spliterator) {
  ...
  @Override
  @SuppressWarnings("unchecked")
  final <P_IN> void copyIntoWithCancel(Sink<P_IN> wrappedSink, java.util.Spliterator<P_IN> spliterator) {
  ...
  @Override
  @SuppressWarnings("unchecked")
  final <P_IN> java.util.Spliterator<E_OUT> wrapSpliterator(java.util.Spliterator<P_IN> sourceSpliterator) {
        if (depth == 0) {
  ...
  @Override
  @SuppressWarnings("unchecked")
  final <P_IN> Node<E_OUT> evaluate(java.util.Spliterator<P_IN> spliterator, boolean flatten, java.util.function.IntFunction<E_OUT[]> generator) {
        if (isParallel()) {
   ...
   */
  abstract <P_IN> Node<E_OUT> evaluateToNode(PipelineHelper<E_OUT> helper, java.util.Spliterator<P_IN> spliterator, boolean flattenTree, java.util.function.IntFunction<E_OUT[]> generator) ;
   ...
   */
  abstract <P_IN> java.util.Spliterator<E_OUT> wrap(PipelineHelper<E_OUT> ph, java.util.function.Supplier<Spliterator<P_IN>> supplier, boolean isParallel) ;
   ...
   * @param supplier the supplier of a spliterator
   */
  abstract java.util.Spliterator<E_OUT> lazySpliterator(java.util.function.Supplier<? extends Spliterator<E_OUT>> supplier) ;
   ...
   */
  abstract void forEachWithCancel(java.util.Spliterator<E_OUT> spliterator, Sink<E_OUT> sink) ;
   ...
   */
  @Override
  abstract Node.Builder<E_OUT> makeNodeBuilder(long exactSizeIfKnown, java.util.function.IntFunction<E_OUT[]> generator) ;
   ...
   */
  <P_IN> Node<E_OUT> opEvaluateParallel(PipelineHelper<E_OUT> helper, java.util.Spliterator<P_IN> spliterator, java.util.function.IntFunction<E_OUT[]> generator) {
   ...
   */
  @SuppressWarnings("unchecked")
  <P_IN> java.util.Spliterator<E_OUT> opEvaluateParallelLazy(PipelineHelper<E_OUT> helper, java.util.Spliterator<P_IN> spliterator) {
