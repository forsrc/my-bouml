...
public interface LongStream extends BaseStream<, > {
   ...
   */
  LongStream filter(java.util.function.LongPredicate predicate) ;
   ...
   * @return the new stream
   */
  LongStream map(java.util.function.LongUnaryOperator mapper) ;
   ...
   * @return the new stream
   */
  <U> Stream<U> mapToObj(java.util.function.LongFunction<? extends U> mapper) ;
   ...
   * @return the new stream
   */
  IntStream mapToInt(java.util.function.LongToIntFunction mapper) ;
   ...
   * @return the new stream
   */
  DoubleStream mapToDouble(java.util.function.LongToDoubleFunction mapper) ;
   ...
   */
  LongStream flatMap(java.util.function.LongFunction<? extends LongStream> mapper) ;
   ...
   * @return the new stream
   */
  LongStream peek(java.util.function.LongConsumer action) ;
   ...
   */
  static LongStream iterate(final long seed, final java.util.function.LongUnaryOperator f)
  {
   ...
   */
  static LongStream generate(java.util.function.LongSupplier s)
  {
