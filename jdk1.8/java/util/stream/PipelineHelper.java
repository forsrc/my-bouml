...
abstract class PipelineHelper<P_OUT> {
   ...
   */
  abstract <P_IN> long exactOutputSizeIfKnown(java.util.Spliterator<P_IN> spliterator) ;
   ...
   */
  abstract <P_IN, S extends Sink<P_OUT>> S wrapAndCopyInto(S sink, java.util.Spliterator<P_IN> spliterator) ;
   ...
   */
  abstract <P_IN> void copyInto(Sink<P_IN> wrappedSink, java.util.Spliterator<P_IN> spliterator) ;
   ...
   * @param spliterator the source {@code Spliterator}
   */
  abstract <P_IN> void copyIntoWithCancel(Sink<P_IN> wrappedSink, java.util.Spliterator<P_IN> spliterator) ;
   ...
   * @return
   */
  abstract <P_IN> java.util.Spliterator<P_OUT> wrapSpliterator(java.util.Spliterator<P_IN> spliterator) ;
   ...
   *         {@code PipelineHelper}
   */
  abstract Node.Builder<P_OUT> makeNodeBuilder(long exactSizeIfKnown, java.util.function.IntFunction<P_OUT[]> generator) ;
   ...
   */
  abstract <P_IN> Node<P_OUT> evaluate(java.util.Spliterator<P_IN> spliterator, boolean flatten, java.util.function.IntFunction<P_OUT[]> generator) ;
