...
;
  ...
  private static class MaskBuilder {
    final java.util.Map<Type, Integer> map;

    MaskBuilder(java.util.Map<Type, Integer> map) {
            this.map = map;
    }
    ...
    java.util.Map<Type, Integer> build() {
   ...
   * 
   */
  private final java.util.Map<Type, Integer> maskTable;
   ...
   * @return the stream flags.
   */
  static int fromCharacteristics(java.util.Spliterator<?> spliterator)
  {
