...
public interface Stream<T> extends BaseStream<, > {
   ...
   * @return the new stream
   */
  LongStream mapToLong(java.util.function.ToLongFunction<? super T> mapper) ;
   ...
   * @return the new stream
   */
  DoubleStream mapToDouble(java.util.function.ToDoubleFunction<? super T> mapper) ;
   ...
   */
  IntStream flatMapToInt(java.util.function.Function<? super T, ? extends IntStream> mapper) ;
   ...
   * @see #flatMap(Function)
   */
  LongStream flatMapToLong(java.util.function.Function<? super T, ? extends LongStream> mapper) ;
   ...
   * @see #flatMap(Function)
   */
  DoubleStream flatMapToDouble(java.util.function.Function<? super T, ? extends DoubleStream> mapper) ;
   ...
   * @return the new stream
   */
  Stream<T> peek(java.util.function.Consumer<? super T> action) ;
  ...
  public interface Builder<T> extends java.util.function.Consumer<> {
    /**
   ...
   */
  static <T> Stream<T> iterate(final T seed, final java.util.function.UnaryOperator<T> f)
  {
   ...
   */
  static <T> Stream<T> generate(java.util.function.Supplier<T> s)
  {
