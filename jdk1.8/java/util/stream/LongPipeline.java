 ...
 * @since 1.8
 */
abstract class LongPipeline<E_IN> extends AbstractPipeline<, , > implements LongStream {
  /**
   ...
   */
  LongPipeline(java.util.function.Supplier<? extends Spliterator<Long>> source, int sourceFlags, boolean parallel) {
   ...
   * @param parallel {@code true} if the pipeline is parallel
   */
  LongPipeline(java.util.Spliterator<Long> source, int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
  }
   ...
   * by casting.
   */
  private static java.util.function.LongConsumer adapt(Sink<Long> sink)
  {
   ...
   */
  private static java.util.Spliterator.OfLong adapt(java.util.Spliterator<Long> s)
  {
  ...
  @Override
  final <P_IN> Node<Long> evaluateToNode(PipelineHelper<Long> helper, java.util.Spliterator<P_IN> spliterator, boolean flattenTree, java.util.function.IntFunction<Long[]> generator) {
        return Nodes.collectLong(helper, spliterator, flattenTree);
  }

  @Override
  final <P_IN> java.util.Spliterator<Long> wrap(PipelineHelper<Long> ph, java.util.function.Supplier<Spliterator<P_IN>> supplier, boolean isParallel) {
        return new StreamSpliterators.LongWrappingSpliterator<>(ph, supplier, isParallel);
  }

  @Override
  @SuppressWarnings("unchecked")
  final java.util.Spliterator.OfLong lazySpliterator(java.util.function.Supplier<? extends Spliterator<Long>> supplier) {
        return new StreamSpliterators.DelegatingSpliterator.OfLong((Supplier<Spliterator.OfLong>) supplier);
  }

  @Override
  final void forEachWithCancel(java.util.Spliterator<Long> spliterator, Sink<Long> sink) {
  ...
  @Override
  final Node.Builder<Long> makeNodeBuilder(long exactSizeIfKnown, java.util.function.IntFunction<Long[]> generator) {
  ...
  @Override
  public final LongStream map(java.util.function.LongUnaryOperator mapper) {
  ...
  @Override
  public final <U> Stream<U> mapToObj(java.util.function.LongFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final IntStream mapToInt(java.util.function.LongToIntFunction mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final DoubleStream mapToDouble(java.util.function.LongToDoubleFunction mapper) {
        Objects.requireNonNull(mapper);
        return new DoublePipeline.StatelessOp<Long>(this, StreamShape.LONG_VALUE,
                                                    StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            @Override
  ...
  @Override
  public final LongStream flatMap(java.util.function.LongFunction<? extends LongStream> mapper) {
        return new StatelessOp<Long>(this, StreamShape.LONG_VALUE,
  ...
  @Override
  public final LongStream filter(java.util.function.LongPredicate predicate) {
  ...
  @Override
  public final LongStream peek(java.util.function.LongConsumer action) {
  ...
  @Override
  public final long reduce(long identity, java.util.function.LongBinaryOperator op) {
        return evaluate(ReduceOps.makeLong(identity, op));
  }

  @Override
  public final java.util.OptionalLong reduce(java.util.function.LongBinaryOperator op) {
        return evaluate(ReduceOps.makeLong(op));
  }

  @Override
  public final <R> R collect(java.util.function.Supplier<R> supplier, java.util.function.ObjLongConsumer<R> accumulator, java.util.function.BiConsumer<R, R> combiner) {
  ...
  @Override
  public final boolean anyMatch(java.util.function.LongPredicate predicate) {
        return evaluate(MatchOps.makeLong(predicate, MatchOps.MatchKind.ANY));
  }

  @Override
  public final boolean allMatch(java.util.function.LongPredicate predicate) {
        return evaluate(MatchOps.makeLong(predicate, MatchOps.MatchKind.ALL));
  }

  @Override
  public final boolean noneMatch(java.util.function.LongPredicate predicate) {
  ...
  static class Head<E_IN> extends LongPipeline<> {
    /**
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    Head(java.util.function.Supplier<? extends Spliterator<Long>> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    Head(java.util.Spliterator<Long> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
  ...
  static abstract class StatelessOp<E_IN> extends LongPipeline<> {
    /**
  ...
  static abstract class StatefulOp<E_IN> extends LongPipeline<> {
    /**
    ...
    @Override
    abstract <P_IN> Node<Long> opEvaluateParallel(PipelineHelper<Long> helper, java.util.Spliterator<P_IN> spliterator, java.util.function.IntFunction<Long[]> generator) ;
