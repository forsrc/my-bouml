...
abstract class AbstractTask<P_IN, P_OUT, R, K extends AbstractTask<P_IN, P_OUT, R, K>> extends java.util.concurrent.CountedCompleter<> {
  /**
   ...
   *                    pipeline
   */
  protected AbstractTask(PipelineHelper<P_OUT> helper, java.util.Spliterator<P_IN> spliterator) {
        super(null);
        this.helper = helper;
   ...
   */
  protected AbstractTask(K parent, java.util.Spliterator<P_IN> spliterator) {
        super(parent);
        this.spliterator = spliterator;
   ...
   */
  protected abstract K makeChild(java.util.Spliterator<P_IN> spliterator) ;
