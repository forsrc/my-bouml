 ...
 * @since 1.8
 */
class SpinedBuffer<E> extends AbstractSpinedBuffer implements java.util.function.Consumer<>, Iterable<> {
  static class OfInt extends SpinedBuffer.OfPrimitive<, , > implements java.util.function.IntConsumer {
    OfInt() {
    }
    ...
    @Override
    public void forEach(java.util.function.Consumer<? super Integer> consumer) {
    ...
    @Override
    protected void arrayForEach(int[] array, int from, int to, java.util.function.IntConsumer consumer) {
  ...
  static class OfLong extends SpinedBuffer.OfPrimitive<, , > implements java.util.function.LongConsumer {
    OfLong() {
    }
    ...
    @Override
    public void forEach(java.util.function.Consumer<? super Long> consumer) {
    ...
    @Override
    protected void arrayForEach(long[] array, int from, int to, java.util.function.LongConsumer consumer) {
            for (int i = from; i < to; i++)
                consumer.accept(array[i]);
    }
  ...
  static class OfDouble extends SpinedBuffer.OfPrimitive<, , > implements java.util.function.DoubleConsumer {
    OfDouble() {
    }
    ...
    @Override
    public void forEach(java.util.function.Consumer<? super Double> consumer) {
    ...
    @Override
    protected void arrayForEach(double[] array, int from, int to, java.util.function.DoubleConsumer consumer) {
            for (int i = from; i < to; i++)
                consumer.accept(array[i]);
    }
   ...
   * elements into it.
   */
  public E[] asArray(java.util.function.IntFunction<E[]> arrayFactory) {
        long size = count();
  ...
  static abstract class OfPrimitive<E, T_ARR, T_CONS> extends AbstractSpinedBuffer implements Iterable<> {
    /**
     * We optimistically hope that all the data will fit into the first chunk,
     * so we try to avoid inflating the spine[] and priorElementCount[] arrays
     * prematurely.  So methods must be prepared to deal with these arrays being
    ...
    @Override
    public abstract void forEach(java.util.function.Consumer<? super E> consumer) ;
    ...
    abstract class BaseSpliterator<T_SPLITR extends Spliterator.OfPrimitive<E, T_CONS, T_SPLITR>> implements java.util.Spliterator.OfPrimitive<, , > {
      /**
       *  The current spine index
       */
      int splSpineIndex;
