...
abstract class AbstractShortCircuitTask<P_IN, P_OUT, R, K extends AbstractShortCircuitTask<P_IN, P_OUT, R, K>> extends AbstractTask<, , , > {
  /**
   * 
   ...
   *                    pipeline
   */
  protected AbstractShortCircuitTask(PipelineHelper<P_OUT> helper, java.util.Spliterator<P_IN> spliterator) {
   ...
   */
  protected AbstractShortCircuitTask(K parent, java.util.Spliterator<P_IN> spliterator) {
