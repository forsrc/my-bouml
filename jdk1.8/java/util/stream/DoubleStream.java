...
public interface DoubleStream extends BaseStream<, > {
   ...
   */
  DoubleStream filter(java.util.function.DoublePredicate predicate) ;
   ...
   * @return the new stream
   */
  DoubleStream map(java.util.function.DoubleUnaryOperator mapper) ;
   ...
   * @return the new stream
   */
  <U> Stream<U> mapToObj(java.util.function.DoubleFunction<? extends U> mapper) ;
   ...
   * @return the new stream
   */
  IntStream mapToInt(java.util.function.DoubleToIntFunction mapper) ;
   ...
   * @return the new stream
   */
  LongStream mapToLong(java.util.function.DoubleToLongFunction mapper) ;
   ...
   */
  DoubleStream flatMap(java.util.function.DoubleFunction<? extends DoubleStream> mapper) ;
   ...
   * @return the new stream
   */
  DoubleStream peek(java.util.function.DoubleConsumer action) ;
   ...
   */
  static DoubleStream iterate(final double seed, final java.util.function.DoubleUnaryOperator f)
  {
   ...
   */
  static DoubleStream generate(java.util.function.DoubleSupplier s)
  {
