...
final class SliceOps {
  ...
  private static <P_IN> java.util.Spliterator<P_IN> sliceSpliterator(StreamShape shape, java.util.Spliterator<P_IN> s, long skip, long limit)
  {
  ...
  @SuppressWarnings("unchecked")
  private static <T> java.util.function.IntFunction<T[]> castingArray()
  {
  ...
  private static final class SliceTask<P_IN, P_OUT> extends AbstractShortCircuitTask<, , , > {
    ...
    SliceTask(AbstractPipeline<P_OUT, P_OUT, ?> op, PipelineHelper<P_OUT> helper, java.util.Spliterator<P_IN> spliterator, java.util.function.IntFunction<P_OUT[]> generator, long offset, long size) {
    ...
    SliceTask(SliceOps.SliceTask<P_IN, P_OUT> parent, java.util.Spliterator<P_IN> spliterator) {
    ...
    @Override
    protected SliceOps.SliceTask<P_IN, P_OUT> makeChild(java.util.Spliterator<P_IN> spliterator) {
    ...
    @Override
    public final void onCompletion(java.util.concurrent.CountedCompleter<?> caller) {
            if (!isLeaf()) {
                Node<P_OUT> result;
