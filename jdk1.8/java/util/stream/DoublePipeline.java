 ...
 * @since 1.8
 */
abstract class DoublePipeline<E_IN> extends AbstractPipeline<, , > implements DoubleStream {
  /**
   ...
   * {@link StreamOpFlag}
   */
  DoublePipeline(java.util.function.Supplier<? extends Spliterator<Double>> source, int sourceFlags, boolean parallel) {
   ...
   * {@link StreamOpFlag}
   */
  DoublePipeline(java.util.Spliterator<Double> source, int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
  }
   ...
   * by casting.
   */
  private static java.util.function.DoubleConsumer adapt(Sink<Double> sink)
  {
   ...
   */
  private static java.util.Spliterator.OfDouble adapt(java.util.Spliterator<Double> s)
  {
  ...
  @Override
  final <P_IN> Node<Double> evaluateToNode(PipelineHelper<Double> helper, java.util.Spliterator<P_IN> spliterator, boolean flattenTree, java.util.function.IntFunction<Double[]> generator) {
        return Nodes.collectDouble(helper, spliterator, flattenTree);
  }

  @Override
  final <P_IN> java.util.Spliterator<Double> wrap(PipelineHelper<Double> ph, java.util.function.Supplier<Spliterator<P_IN>> supplier, boolean isParallel) {
        return new StreamSpliterators.DoubleWrappingSpliterator<>(ph, supplier, isParallel);
  }

  @Override
  @SuppressWarnings("unchecked")
  final java.util.Spliterator.OfDouble lazySpliterator(java.util.function.Supplier<? extends Spliterator<Double>> supplier) {
        return new StreamSpliterators.DelegatingSpliterator.OfDouble((Supplier<Spliterator.OfDouble>) supplier);
  }

  @Override
  final void forEachWithCancel(java.util.Spliterator<Double> spliterator, Sink<Double> sink) {
  ...
  @Override
  final Node.Builder<Double> makeNodeBuilder(long exactSizeIfKnown, java.util.function.IntFunction<Double[]> generator) {
  ...
  @Override
  public final DoubleStream map(java.util.function.DoubleUnaryOperator mapper) {
  ...
  @Override
  public final <U> Stream<U> mapToObj(java.util.function.DoubleFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final IntStream mapToInt(java.util.function.DoubleToIntFunction mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final LongStream mapToLong(java.util.function.DoubleToLongFunction mapper) {
        Objects.requireNonNull(mapper);
  ...
  @Override
  public final DoubleStream flatMap(java.util.function.DoubleFunction<? extends DoubleStream> mapper) {
        return new StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE,
  ...
  @Override
  public final DoubleStream filter(java.util.function.DoublePredicate predicate) {
  ...
  @Override
  public final DoubleStream peek(java.util.function.DoubleConsumer action) {
  ...
  @Override
  public void forEachOrdered(java.util.function.DoubleConsumer consumer) {
  ...
  @Override
  public final double reduce(double identity, java.util.function.DoubleBinaryOperator op) {
        return evaluate(ReduceOps.makeDouble(identity, op));
  }

  @Override
  public final java.util.OptionalDouble reduce(java.util.function.DoubleBinaryOperator op) {
        return evaluate(ReduceOps.makeDouble(op));
  }

  @Override
  public final <R> R collect(java.util.function.Supplier<R> supplier, java.util.function.ObjDoubleConsumer<R> accumulator, java.util.function.BiConsumer<R, R> combiner) {
  ...
  @Override
  public final boolean anyMatch(java.util.function.DoublePredicate predicate) {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ANY));
  }

  @Override
  public final boolean allMatch(java.util.function.DoublePredicate predicate) {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ALL));
  }

  @Override
  public final boolean noneMatch(java.util.function.DoublePredicate predicate) {
  ...
  static class Head<E_IN> extends DoublePipeline<> {
    /**
     ...
     */
    Head(java.util.function.Supplier<? extends Spliterator<Double>> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    Head(java.util.Spliterator<Double> source, int sourceFlags, boolean parallel) {
            super(source, sourceFlags, parallel);
    }
  ...
  static abstract class StatelessOp<E_IN> extends DoublePipeline<> {
    /**
  ...
  static abstract class StatefulOp<E_IN> extends DoublePipeline<> {
    /**
    ...
    @Override
    abstract <P_IN> Node<Double> opEvaluateParallel(PipelineHelper<Double> helper, java.util.Spliterator<P_IN> spliterator, java.util.function.IntFunction<Double[]> generator) ;
