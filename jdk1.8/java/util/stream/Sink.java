 ...
 * @since 1.8
 */
interface Sink<T> extends java.util.function.Consumer<> {
  /**
  ...
  public interface OfInt extends Sink<>, java.util.function.IntConsumer {
    @Override
  ...
  public interface OfLong extends Sink<>, java.util.function.LongConsumer {
    @Override
  ...
  public interface OfDouble extends Sink<>, java.util.function.DoubleConsumer {
    @Override
  ...
  public static abstract class ChainedReference<T, E_OUT> implements Sink<> {
  ...
  public static abstract class ChainedInt<E_OUT> implements Sink.OfInt {
    protected final Sink<? super E_OUT> downstream;
  ...
  public static abstract class ChainedLong<E_OUT> implements Sink.OfLong {
    protected final Sink<? super E_OUT> downstream;
  ...
  public static abstract class ChainedDouble<E_OUT> implements Sink.OfDouble {
    protected final Sink<? super E_OUT> downstream;
