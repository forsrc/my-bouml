...
public interface IntStream extends BaseStream<, > {
   ...
   * @return the new stream
   */
  LongStream mapToLong(java.util.function.IntToLongFunction mapper) ;
   ...
   * @return the new stream
   */
  DoubleStream mapToDouble(java.util.function.IntToDoubleFunction mapper) ;
   ...
   */
  IntStream flatMap(java.util.function.IntFunction<? extends IntStream> mapper) ;
   ...
   * @return the new stream
   */
  IntStream peek(java.util.function.IntConsumer action) ;
   ...
   */
  static IntStream iterate(final int seed, final java.util.function.IntUnaryOperator f)
  {
   ...
   */
  static IntStream generate(java.util.function.IntSupplier s)
  {
